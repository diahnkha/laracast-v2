<header class="max-w-xl mx-auto mt-20 text-center">
            ...
            <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                ...
                <div x-data="{show: false}" @click.away="show=false">
                    <button 
                    @click="show=! show" 
                    class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 flex text-left lg:inline-flex">
                    ...
                    <div x-show="show" class="py-2 absolute w-full mt-2 bg-gray-100 rounded-xl z-50" style="display:none"> 
